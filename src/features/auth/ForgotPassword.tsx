        ...
        <div className="w-[324px] h-[469px]">
          <form>
            ...
            <div className=" mt-3">
              ...
              <input className=" w-full px-2 py-[10px] mt-2 rounded-md bg-transparent focus:outline-none border hover:border-white border-[#7c7c7c]" type="email" name="" id="" />
            </div>
            <p className="mt-4">
              <a className="text-white hover:text-[#1ed760] text-sm font-semibold underline" href="">Need support?</a>
            </p>
            <button className="mt-7 px-2 py-[12px] rounded-full border-transparent text-base font-bold w-full bg-[#1ed760] hover:brightness-125 transition" type="submit">Send link</button>
          </form>
        </div>
      </section>
