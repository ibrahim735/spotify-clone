    ...
    return (
        <div className="pt-8 h-fit bg-gradient-to-b from-firstGradient to-secondGradient flex items-center justify-center flex-col">
            <div className="p-10 flex flex-col items-center justify-center h-fit w-[54.5%] bg-gradient-to-b from-secondGradient to-[hsl(0,0%,7%)] rounded-xl">
                ...
                <hr className="my-10 w-full border-[#302f2f]" />
                ...
                <div className="text-white font-medium text-base p-8">
                    <Link className="underline hover:text-spotifyGreen" to="/forgotpassword"><p>Forgot your password?</p></Link>
                </div>
                <div className="text-white font-medium text-base pb-8">
                    <h2 className="flex gap-2">
                        <span className="text-customGray">Don't have an account?</span>
                        <Link className="underline text-white hover:text-spotifyGreen" to="/signup"><span>Sign up for Spotify</span></Link>
                    </h2>
                </div>
            </div>

            <footer className="mt-8 bg-[hsl(0,0%,7%)] w-full p-8">
                <p className="text-center text-customGray font-normal text-xs">This site is protected by reCAPTCHA and the Google <a className="underline" href="https://policies.google.com/privacy">Privacy Policy</a> and <a className="underline" href="https://policies.google.com/terms">Terms of Service</a> apply</p>
            </footer>
        </div>
    );
};
